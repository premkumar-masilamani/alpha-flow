...
export const CANDLESTICK_PATTERNS: CandlestickPatternDetail[] = [
    ...
    },
    {
        ...
        psychology: 'Bears counter-attacked with equal force, nullifying intraday panic.',
    ...
    },
    {
        ...
        group: 'bullish-reversals',
        groupName: 'Bullish Reversal',
        structure: 'Black Marubozu followed by a green Marubozu that gaps up above Day 1\'s open.',
    ...
    },
    {
        ...
        group: 'bullish-reversals',
        groupName: 'Bullish Reversal',
        structure: 'Long red candle; black body with long lower shadow making a new low; small green body trading above the extreme low.',
    ...
    },
    {
        ...
        group: 'bullish-reversals',
        groupName: 'Bullish Reversal',
        structure: 'Two falling Marubozus, an inverted-hammer-like black candle gapping down, engulfed by a fourth black/white reversal candle.',
        psychology: 'Climax selling frenzy completely exhausts all remaining supply.',
        outcome: 'Violent short-squeeze snapback rally.',
        svgMarkup: '<line x1="35" y1="25" x2="35" y2="60" stroke="#e74c3c" stroke-width="2"/> <rect x="27" y="25" width="16" height="35" fill="#e74c3c" rx="1" stroke="#b30000" stroke-width="1"/> <line x1="60" y1="50" x2="60" y2="85" stroke="#e74c3c" stroke-width="2"/> <rect x="52" y="50" width="16" height="35" fill="#e74c3c" rx="1" stroke="#b30000" stroke-width="1"/> <line x1="85" y1="60" x2="85" y2="105" stroke="#e74c3c" stroke-width="2"/> <rect x="78" y="95" width="14" height="10" fill="#e74c3c" rx="1" stroke="#b30000" stroke-width="1"/> <line x1="115" y1="45" x2="115" y2="115" stroke="#2ecc71" stroke-width="2"/> <rect x="106" y="50" width="18" height="60" fill="#2ecc71" rx="1" stroke="#1b7a43" stroke-width="1"/>',
    },
    {
    ...
    },
    {
        ...
        group: 'bearish-reversals',
        groupName: 'Bearish Reversal',
        structure: 'White Marubozu followed by a red Marubozu that gaps down beneath Day 1\'s open.',
