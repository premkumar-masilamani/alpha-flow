            ...
            {hoverData && (
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-1.5">
                        ...
                        <span className="text-slate-400">Buyer Pressure:</span> <span
                        className={`text-right font-bold ${(hoverData.d.buyer_capital / hoverData.d.total_capital) > 0.52 ? 'text-green-400' : (hoverData.d.buyer_capital / hoverData.d.total_capital) < 0.48 ? 'text-red-400' : 'text-slate-300'}`}>
