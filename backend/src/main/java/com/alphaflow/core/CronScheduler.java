...
public class CronScheduler {
    ...
    private final OnBalanceVolumeComputer onBalanceVolumeComputer;
    ...
    public CronScheduler(
            ...
            OnBalanceVolumeComputer onBalanceVolumeComputer,
        ...
        this.onBalanceVolumeComputer = onBalanceVolumeComputer;
    ...
    private void run() {
        try {
            ...
            log.info("Step 5/7: Computing OBV...");
