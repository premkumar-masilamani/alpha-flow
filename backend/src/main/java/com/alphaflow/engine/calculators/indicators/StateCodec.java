 ...
 *
 * <p>{@code indicator_state.internals}.
 *
 * <p>Decimals are stored as <b>strings</b> (e.g. {@code {"ema":"123.456789012345"}}), never JSON
 *
 * <p>floats, so the running state never round-trips through {@code double} and resume stays
 * bit-exact.
 */
