 ...
 *     <p>(no rows during warm-up), in chronological order.
 * @param newStateJson the recursive running state as of the last input bar, as a JSON object of
 *     <p>string-encoded decimals, or {@code null} for windowed indicators (and for
 *     <p>recursive indicators still inside their warm-up period). The engine persists
 *     <p>this to {@code indicator_state.internals}, always lagging the latest bar.
 */
