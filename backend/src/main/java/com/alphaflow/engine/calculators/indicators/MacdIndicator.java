 ...
 * checkpoint) is only produced once the signal EMA is seeded — before that the warm-up is
 * recomputed each run — which avoids having to serialize the signal EMA's partial seeding window.
 */
@Component
