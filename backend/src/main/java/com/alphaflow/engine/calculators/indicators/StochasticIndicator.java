 ...
 *
 * <p>range is zero, rawK is defined as 0 to avoid division by zero. Windowed and non-recursive
 *
 * <p>({@code newStateJson == null}); resumed purely from the price bars the caller loads.
 */
@Component
