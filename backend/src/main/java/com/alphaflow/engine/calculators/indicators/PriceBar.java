 ...
 * (Stochastic) read {@link #high()}/{@link #low()}/{@link #close()} directly. The same bar shape is
 * produced from both {@code daily_prices} and {@code weekly_prices}, so indicators are blind to the
 * timeframe they run on.
 */
