 ...
 * computed on which timeframe. Bound from {@code alphaflow.indicators.*} so the set can be tuned via
 * configuration without recompiling the engine. The indicator math lives in code; only the
