...
class AnalysisServiceTest {
    ...
    void setUp() {
        ...
        analysisService = new AnalysisService(dailyPriceService, indicatorService, tickerRepository, analysisResultRepository);
    }

    private OhlcvDTO candle(LocalDate date, double open, double high, double low, double close, long volume) {
    ...
    private IndicatorSeriesDTO series(String type, String source, String params, List<IndicatorPointDTO> points) {
    ...
    private IndicatorPointDTO point(LocalDate date, Map<String, BigDecimal> values) {
        return IndicatorPointDTO.builder()
                .date(date)
                .values(values)
                .build();
    }
    ...
    void testComputeAndPersistCalculatesSignalsCorrectly() {
        ...
        List<IndicatorPointDTO> macdPoints = List.of(
                ...
                point(TODAY, Map.of("macd", BigDecimal.valueOf(1.5), "signal", BigDecimal.valueOf(1.3)))
        );
