...
class AnalysisServiceTest {
  ...
  private IndicatorPointDTO point(
  ...
  void testGetAnalysisPullsPersistedResult() {
    ...
    when(tickerRepository.findByTickerSymbolIgnoreCase(SYMBOL)).thenReturn(
    ...
    when(analysisResultRepository.findByTicker(ticker)).thenReturn(
  ...
  void testComputeAndPersistCalculatesSignalsCorrectly() {
    ...
    IndicatorSeriesDTO macdSeries = series(
    ...
    List<IndicatorPointDTO> stochPoints = List.of(
      ...
      point(
        ...
        Map.of("k", BigDecimal.valueOf(70), "d", BigDecimal.valueOf(75))
      ...
      point(
        ...
        Map.of("k", BigDecimal.valueOf(82), "d", BigDecimal.valueOf(80))

      )

    );

    IndicatorSeriesDTO stochSeries = series(
    ...
    List<IndicatorPointDTO> rsiPoints = List.of(
    ...
    IndicatorSeriesDTO rsiSeries = series(
    ...
    List<IndicatorPointDTO> volSmaPoints = List.of(
    ...
    IndicatorSeriesDTO volSmaSeries = series(
    ...
    IndicatorSeriesDTO ema5 = series(
    ...
    IndicatorSeriesDTO ema13 = series(
    ...
    IndicatorSeriesDTO ema26 = series(
    ...
    when(
      ...
      List.of(stochSeries, rsiSeries, volSmaSeries, ema5, ema13, ema26)
    ...
    when(
      ...
      analysisResultRepository.save(any(AnalysisResult.class))
    ...
    verify(analysisResultRepository, times(1)).save(
  ...
  void testComputeAnalysisContinuesOnTickerFailure() {
    ...
    when(
      ...
      dailyPriceService.getDailyPriceByTickerName("T1", 0, 50)
    ...
    List<OhlcvDTO> candles2 = List.of(

      candle(TODAY, 100, 105, 95, 100, 1000)

    );

    when(

      dailyPriceService.getDailyPriceByTickerName("T2", 0, 50)

    ).thenReturn(candles2);

    when(

      indicatorService.getIndicatorSeries("T2", Timeframe.WEEKLY, 0, 10)

    ).thenReturn(List.of());

    when(

      indicatorService.getIndicatorSeries("T2", Timeframe.DAILY, 0, 50)

    ).thenReturn(List.of());

    when(analysisResultRepository.findByTicker(ticker2)).thenReturn(
    ...
    verify(analysisResultRepository).save(

      argThat(res -> "T2".equals(res.getTicker().getTickerSymbol()))
  ...
  void testEvaluateDailyStochasticFlatReturnsHold() {
    ...
    List<IndicatorPointDTO> stochPoints = List.of(
      ...
      point(
        ...
        Map.of("k", BigDecimal.valueOf(80), "d", BigDecimal.valueOf(80))
