...
class GlobalExceptionHandlerTest {
  ...
  void testHandleNotFound() {
    ...
    ResponseEntity<Map<String, Object>> response = handler.handleNotFound(
        ...
        new ResourceNotFoundException("Not found message"), request);
  ...
  void testHandleBadRequest() {
    ...
    ResponseEntity<Map<String, Object>> response = handler.handleBadRequest(
        ...
        new IllegalArgumentException("Bad request message"), request);
  ...
  void testHandleBadRequestNullMessage() {
    ...
    ResponseEntity<Map<String, Object>> response = handler.handleBadRequest(
        ...
        new IllegalArgumentException((String) null), request);
